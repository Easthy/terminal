...
<script type="text/javascript">
    ...
    $(document).on('tap','.calendar-has-activity',function(){
        console.log('calendar.selected_date',calendar.selected_date);
    ...
    $('.calendar-cell:not(.calendar-cell-gray) .calendar-has-activity:first').tap();
</script>